...
class SupabaseAuthClientTest {
    ...
    @Test
    void verifiesBearerIdentityButNeverUsesEditableMetadataForAuthorization() {
        ...
        assertThat(principal.trustedRole()).isNull();
        assertThat(principal.requestedRegistrationRole()).isNull();
        server.verify();
    }
