...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({AvatarValidationException.class, ProfileValidationException.class})
    ...
    ResponseEntity<ApiErrorResponse> handleStorage(ProfileStorageException exception, HttpServletRequest request) {
