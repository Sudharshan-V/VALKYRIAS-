...
export const ProfileEditForm: React.FC<ProfileEditFormProps> = ({ profile, onSaved, onCancel }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-7" noValidate>
      ...
      <div className="sticky bottom-0 flex flex-col-reverse gap-3 border-t border-white/5 bg-surface-container/95 py-4 backdrop-blur-xl sm:flex-row sm:justify-end">
        <button
          type="button"
          onClick={onCancel}
          disabled={saving}
        ...
        >
          {saving ? <ValkyriasLoader compact label="Saving profile" /> : <Check className="h-4 w-4" />}
