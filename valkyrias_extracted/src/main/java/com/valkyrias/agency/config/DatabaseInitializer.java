...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (!userRepository.existsByEmail("admin@valkyrias.co")) {
            ...
            System.out.println(">>> Seeded Admin User: admin@valkyrias.co / valkyrias2026");
        }
        ...
        if (!userRepository.existsByEmail("tanishq@reliancejewels.com")) {
            ...
            System.out.println(">>> Seeded Client User: tanishq@reliancejewels.com / valkyrias2026");
        }
        ...
        if (!userRepository.existsByEmail("marcus.vane@valkyrias.co")) {
            ...
            System.out.println(">>> Seeded Editor User: marcus.vane@valkyrias.co / valkyrias2026");
        }
    }
}
